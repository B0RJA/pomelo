...
const char* app_endpoint_api_endpoint = "d9heg9xi80.execute-api.eu-central-1.amazonaws.com";
const char* app_endpoint_api_handler = "default/pomeloHandler";
const char* app_endpoint_api_key = "haHYxYzjEk4bwkxhkjnKo65wcQHKtyhl3gzfcfyy";

uint32_t app_endpoint_tLog;
uint32_t app_endpoint_entries;
bool app_endpoint_logging;

bool app_endpoint_run(uint8_t buttonFlags, uint8_t serviceFlags)
{
